...
def initiation():
	...
	while True:
		...
		draw_message(pixels, '<>KYLE GILLASPY()', DARK_RED, BLACK, True, 0.15)
		draw_message(pixels, '<>RICK HUYNH()', DARK_RED, BLACK, True, 0.15)
		draw_message(pixels, '<>KAMRAN JAHADI()', DARK_RED, BLACK, True, 0.15)
		draw_message(pixels, '<>DARREN JIAN()', DARK_RED, BLACK, True, 0.15)
		draw_message(pixels, '<>EVERETT LIN()', DARK_RED, BLACK, True, 0.15)
		draw_message(pixels, '<>NEHA PUSARLA()', DARK_RED, BLACK, True, 0.15)
		draw_message(pixels, '<>RAEEK RAHMAN()', DARK_RED, BLACK, True, 0.15)
		draw_message(pixels, '<>JONATHAN SONG()', DARK_RED, BLACK, True, 0.15)
		draw_message(pixels, '<>AJ TAN()', DARK_RED, BLACK, True, 0.15)
		draw_message(pixels, '<>BRITNEY TRAN()', DARK_RED, BLACK, True, 0.15)
