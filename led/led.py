...
def initiation():
	...
	while True:
		...
		draw_message(pixels, "WELCOME TO INITIATION!", YELLOW, BLACK, True, 0.1)
		draw_message(pixels, '<>CONGRATS TO THE TAU PLEDGE CLASS()', DARK_RED, BLACK, False, 0.1)
		draw_message(pixels, 'PLEDGES', DARK_RED, BLACK, False, 0.1)
		draw_message(pixels, '<>HEATHER GAN()', DARK_RED, BLACK, True, 0.1)
		draw_message(pixels, '<>KYLE GILLASPY()', DARK_RED, BLACK, True, 0.1)
		draw_message(pixels, '<>RICK HUYNH()', DARK_RED, BLACK, True, 0.1)
		draw_message(pixels, '<>KAMRAN JAHADI()', DARK_RED, BLACK, True, 0.1)
		draw_message(pixels, '<>DARREN JIAN()', DARK_RED, BLACK, True, 0.1)
		draw_message(pixels, '<>EVERETT LIN()', DARK_RED, BLACK, True, 0.1)
		draw_message(pixels, '<>NEHA PUSARLA()', DARK_RED, BLACK, True, 0.1)
		draw_message(pixels, '<>RAEEK RAHMAN()', DARK_RED, BLACK, True, 0.1)
		draw_message(pixels, '<>JONATHAN SONG()', DARK_RED, BLACK, True, 0.1)
		draw_message(pixels, '<>AJ TAN()', DARK_RED, BLACK, True, 0.1)
		draw_message(pixels, '<>BRITNEY TRAN()', DARK_RED, BLACK, True, 0.1)
		draw_message(pixels, '<>WILL XU()', DARK_RED, BLACK, True, 0.1)
		draw_message(pixels, '<>ESTHER ZHAO()', DARK_RED, BLACK, True, 0.1)
		draw_message(pixels, 'THANK YOU FOR COMING!', DARK_RED, BLACK, True, 0.1)
		draw_snake(pixels, DARK_RED, True)
